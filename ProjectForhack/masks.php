...
<body class="body">
	...
	<div class="slogan">
		<p class="font-l">Как правильно носить маску</p>
	</div>
	<div class="osnova mx">
		<div class="chetvert mx border border-radius" >
			<img src="img/pravilno/karman.svg " class="mx" style="padding-right:100px">
			<p class="font-m c-gr t-c fs2">Класть в карман, а потом снова использовать нельзя</p>
		</div> 
		<div class="chetvert mx border-radius">
			
			<img src="img/pravilno/zashita.svg " class="mx" style="padding-right:100px;">
			<p class="font-m c-gr t-c fs2">Маска должна закрывать нос, рот и подбородок	</p>
		</div> 
		<div class="chetvert mx border-radius">
			
			<img src="img/pravilno/rukimaska.svg " class="mx" style="padding-right:100px">
	...
	<div class="osnova mx">
		<div class="chetvert mx border border-radius">
			<img src="img/pravilno/kaplyamasks.svg " class="mx" style="padding-right:100px">
			<p class="font-m c-gr t-c fs2">Влажную и загрязненную маску требуется утилизировать незамедлительно</p>
		</div> 
		<div class="chetvert mx border-radius">
			<img src="img/pravilno/gorod.svg " class="mx" style="padding-right:100px">
		...
		<div class="chetvert mx border-radius">
			<img src="img/pravilno/avtobus.svg " class="mx" style="padding-right:100px">
			<p class="font-m c-gr t-c fs2">Маску рекомендуют носить в местах большого скопления людей</p>
